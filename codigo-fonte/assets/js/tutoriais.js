// assets/js/tutoriais.js

document.addEventListener('DOMContentLoaded', () => {
    console.log("Página de Tutoriais Técnicos carregada.");
    ...
    if (menuIconImage && mainDropdown) {
        ...
        console.warn("Elementos do menu do header não encontrados na página de tutoriais.");
    }
});
